...
<Scaffold>
    ...
    <div class="loginBox" style:width="30rem">
        <Card --cardPadding="2.5rem" --cardBg="#fafafa">
            <Text tag="h1" heading3>Register</Text>
            <form action="http://127.0.0.1:5000/register" style:display="contents" method="POST">
                <Text tag="label" body2 attributes={{"for":"username"}}>Username</Text>
                <TextInput text="" name="username"></TextInput>
                <Text tag="label" body2 attributes={{"for":"password"}}>Password</Text>
                <PasswordInput name="password" text=""></PasswordInput>
